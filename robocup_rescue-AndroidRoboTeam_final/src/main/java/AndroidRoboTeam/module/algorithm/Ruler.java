...
public class Ruler {
    ...
    public static double getDistance(Polygon polygon, rescuecore2.misc.geometry.Point2D point, boolean ignoreInside) {
        ...
        for (int i = 0; i < count; i++) {
            int j = (i + 1) % count;
            rescuecore2.misc.geometry.Point2D stPoint = new rescuecore2.misc.geometry.Point2D(polygon.xpoints[i],
                    polygon.ypoints[i]);
            rescuecore2.misc.geometry.Point2D endPoint = new rescuecore2.misc.geometry.Point2D(polygon.xpoints[j],
                    polygon.ypoints[j]);
    ...
    public static double getDistance(Polygon polygon, Pair<Integer, Integer> location, boolean ignoreInside) {
        return getDistance(polygon, new rescuecore2.misc.geometry.Point2D(location.first(), location.second()),
                ignoreInside);
    }
